...
# liefert ein Objekt der subprocess.Popen Klasse
...
def run_tests(program_args, use_shell):
    #program_args sind die argumente die my_testris.py uebergeben wurden
...
def main():
    try: cmdline, use_shell = find_learntris()
        ...
        cmd = cmdline[0] #/Users/martin/workspace/learntris/test.py
        print("cmd: " + cmd)
        print(cmdline)
        print(use_shell) #bei mir false
        try:
            try:
